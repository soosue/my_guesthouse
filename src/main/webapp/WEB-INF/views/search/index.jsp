...
<head>
    ...
    <style type="text/css">
        ...
        ${root} /resources/images/JEJU_STAY.jpg"); */
            ...
            <form name="form" action="${root}/search" method="get" onsubmit="return confirmSubmit()">
                ...
                <div class="checkInOutContainer">
                    <div class="checkInContainer">
                        ...
                        <div class="checkInInput"><input readonly="readonly" style="background-color: white;"
                                                         class="form-control" type="text" name="checkIn"
                                                         id="checkIn"/><i
                                class="calenderIn far fa-calendar-alt fa-3x"></i></div>
                    </div>
                    <div class="checkOutContainer">
                        <div class="checkOutLabel"><label for="checkOut">Check Out</label></div>
                        <div class="checkOutInput"><input readonly="readonly" style="background-color: white;"
                                                          class="form-control" type="text" name="checkOut"
                                                          id="checkOut"/><i
                                class="calenderOut far fa-calendar-alt fa-3x"></i></div>
                    </div>
                </div>
                ...
                <div class="localContainer form-check-inline">
                    ...
                    <div class="localSeoguipo">
                        ...
                        <div class="custom-control custom-checkbox mb-3">
                            <input type="checkbox" class="custom-control-input etc" id="seoguipoEast"
                                   value="seoguipoEast"/>
                            <label class="custom-control-label" for="seoguipoEast">서귀포시 동부</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-3">
                            <input type="checkbox" class="custom-control-input etc" id="seoguipoWest"
                                   value="seoguipoWest"/>
                ...
                <div class="searchContainer">
                    <div>숙소이름</div>
                    <input class="form-control" type="text" name="searchHouseName" placeholder="숙소명이름"/>
...
<div style="background: url(http://fiximage.10x10.co.kr/web2018/main/bg_pattern_slash.png) 0 0 repeat;    height: 44rem;">
    <div style="width: 90rem; height: 40rem; margin: 0 auto;">
        <div align="center">
            <div style="width: 100%; height: 10rem; line-height: 10rem; font-size: 3rem; margin-top: 10rem; font-weight: bold;">
                JEJU GUEST HOUSE
            </div>
        ...
        <c:forEach var="ho" items="${houseImgDto}" varStatus="i">
            ...
            <div id="demo${i.index}" class="carousel slide" data-ride="carousel"
                ...
                <div class="carousel-inner" style="width: 20rem; height: 20rem;">
                    <div class="carousel-item active" style="width: 20rem; height: 20rem;">
                        <img style="width: 20rem; height: 20rem;" src="${root}/image/${ho.fileList[0].fileName}"
                             alt="이미지가 없습니다.">
                    </div>
                    <div class="carousel-item">
                        <img style="width: 20rem; height: 20rem;" src="${root}/image/${ho.fileList[1].fileName}"
                             alt="이미지가 없습니다.">
                    </div>
                    <div class="carousel-item">
                        <img style="width: 20rem; height: 20rem;" src="${root}/image/${ho.fileList[2].fileName}"
                             alt="이미지가 없습니다.">
                    </div>
                </div>
...
<div style="background: url(http://fiximage.10x10.co.kr/web2018/main/bg_pattern_slash.png) 0 0 repeat;  margin-top: 10rem; height: 44rem; margin-bottom: 5rem;">
    <div style="width: 90rem; height: 41rem; margin: 0 auto;">
        ...
        <c:forEach var="ex" items="${experienceImgDto}" varStatus="i">
            ...
            <div id="exDemo${i.index}" class="carousel slide" data-ride="carousel"
                 style="width: 20rem; height: 20rem; float: left; margin-left: 2rem; margin-top: 5rem;">
                ...
                <div class="carousel-inner" style="width: 20rem; height: 20rem;">
                    <div class="carousel-item active" style="width: 20rem; height: 20rem;">
                        <img style="width: 20rem; height: 20rem;" src="${root}/exImage/${ex.exFileList[0].fileName}"
                             alt="img">
                    </div>
                    <div class="carousel-item">
                        <img style="width: 20rem; height: 20rem;" src="${root}/exImage/${ex.exFileList[1].fileName}"
                             alt="img">
                    </div>
                    <div class="carousel-item">
                        <img style="width: 20rem; height: 20rem;" src="${root}/exImage/${ex.exFileList[2].fileName}"
                             alt="img">
                    </div>
                </div>
