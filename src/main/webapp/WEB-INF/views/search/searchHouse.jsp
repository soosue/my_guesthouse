    ...
    <div class="emptyContainer">
        <div class="filterContainer">
            <div class="buttonContainer">
                ...
                <div class="filterButton">
                    <button class="peopleButton btn btn-outline-primary" type="button">인원 ${people}명</button>
                </div>
                <div class="filterButton">
                    <button class="localButton btn btn-outline-primary" type="button">지역</button>
                </div>
            </div>
    ...
    <div class="formContainer">
        <form name="form" action="${root}/search" method="get" onsubmit="return confirmSubmit()">
            ...
            <div class="searchContainer">
                ...
                <button type="submit" class="searchBtn btn btn-primary" onsubmit="confirmSubmit()">검색</button>
            </div>
        </form>
    </div>
</div>
