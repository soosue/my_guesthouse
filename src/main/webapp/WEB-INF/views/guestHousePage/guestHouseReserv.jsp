...
<div class="rePage">
    ...
    <button class="btn" style="background-color: #008489; color: white; font-weight: bold;"
            onclick="reserveCompleteFun('${root}', '${hostDto.houseCode}','${memberCode}','${checkIn}','${checkOut}','${people}','${total}')">
        예약요청하기
    </button>
</div>
