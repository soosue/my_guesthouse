    ...
    <div class="guestHouse">
        ...
        <div class="facilites">
            ...
            <div id="fRight">
                ...
                <c:if test="${hostDto.necessary == 'on'}">
                    <p id="necessary"><img alt="icon" src="./../resources/css/images/Icon/noun_towel_2888408.png">
                        necessary </p>
                </c:if>
                ...
                <c:if test="${hostDto.aircon == 'on'}">
                    <p id="aircon"><img alt="icon"
                                        src="./../resources/css/images/Icon/noun_Air Conditioner_1515986.png"> aircon
                    </p>
                </c:if>
                ...
                <c:if test="${hostDto.safety == 'on'}">
                    <p id="safety"><img alt="icon"
                                        src="./../resources/css/images/Icon/noun_Fire Extinguisher_1176908.png"> safety
                    </p>
                </c:if>
            ...
            <div id="fLeft">
                ...
                <c:if test="${hostDto.mart == 'on'}">
                    <p id="mart"><img alt="icon" src="./../resources/css/images/Icon/noun_Grocery Store_79159.png"> mart
                    </p>
                </c:if>
                ...
                <c:if test="${hostDto.kitchen == 'on'}">
                    <p id="kitchen"><img alt="icon" src="./../resources/css/images/Icon/noun_Kitchen_1092638.png">
                        kitchen</p>
                </c:if>
                            ...
                            <div class="bottom" style="text-align: left; margin-left: 18rem; margin-top: 1rem;">
                                ...
                                <input type="hidden" name="houseCode"
                                       value="${hostDto.houseCode}"/> <input type="submit"
                                                                             class="btn btn-light" value="확인"/> <input
                                    type="button"
        ...
        <div id="reserveMargin">
            ...
            <c:if test="${emailCheck == 1}">
                <button class="btn"
                        ...
                        onclick="reservationFun('${root}','${hostDto.houseCode}','${memberCode}','${emailCheck}')">예약하기
                </button>
            </c:if>
...
<div align="center" style="margin: 6rem;">
    <c:if test="${memberLevel == 'Admin'}">
        <button id="btn" type="button" class="btn btn-warning" name="stateOk"
                onclick="location.href='${root}/admin/state.do?houseCode='+'${hostDto.houseCode}'+'&memberCode='+'${hostDto.memberCode}'">
            승인
        </button>
        <button id="btn" type="button" class="btn btn-light" name="stateNo"
                onclick="location.href='${root}/admin/stateNo.do?houseCode='+'${hostDto.houseCode}'+'&memberCode='+'${hostDto.memberCode}'">
            거절
        </button>
    </c:if>
</div>
