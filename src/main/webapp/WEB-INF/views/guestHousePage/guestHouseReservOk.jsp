...
<div align="center" style="margin-top: 2rem;">
    <button style="margin-right: 1.5rem;" id="btn" type="button" class="btn btn-warning" name="home"
            onclick="location.href='${root}'">Home
    </button>
    <button id="btn" type="button" class="btn btn-light" name="myInfpo"
            onclick="location.href='${root}/guestdelluna/myInfo.do'">myPage
    </button>
</div>
<!-- footer 겹침현상 제거 -->
