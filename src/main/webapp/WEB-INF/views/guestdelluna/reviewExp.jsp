                    ...
                    <div style="float: left">
                        ...
                        <div>
									<textarea
                                            ...
                                            rows="6" cols="50" name="revContent"
                                            disabled="disabled">${expReview.revContent}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary"
                                        ...
                                        onclick="delExpRev('${root}','${expReview.exReserveCode}')">네
                                </button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
										<textarea style="float: left; border: 1px solid #008489; background: white"
                                                  rows="5" cols="40"
                                                  name="expRevContent">${expReview.revContent}</textarea>

                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary"
                                        style="background: #008489; border: 1px solid #008489;"
                                        onclick="expUpdateOk('${root}','${expReview.exReserveCode}','${status.count}')">
                                    수정완료
                                </button>
                                <button type="button" class="btn btn-default"
                                        data-dismiss="modal">닫기
