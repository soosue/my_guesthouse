...
<form action="${root}/admin/memberUpdateOk.do?memberCode=${memberDto.memberCode}" method="post"
    ...
    <div align="center" style="margin-top:50px;">
        ...
        <div border="1">
            <div>
                ...
                <div align="center" height="20" width="125"><input type="text" name="point" value="${memberDto.point}"/>
                </div>
