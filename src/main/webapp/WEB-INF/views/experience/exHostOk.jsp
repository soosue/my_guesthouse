        ...
        <div align="center">
            ...
            <div style="margin: 5rem; width: 60rem; /* border: 0.1rem solid red; */ height: auto; ">
                <div style="/* border: 0.1rem solid orange; */ width: 40rem; height: auto;">
                    ...
                    <div id="name"
                         style="width: 20rem; margin-left: 10rem; text-align: left;"> ${experienceDto.exName}</div>
                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">체험 설명</div>
                    <div id="explain"
                         style="word-break: break-all; width: 20rem; margin-left: 10rem; margin-top: 2rem; text-align: left;">${experienceDto.exExplain}</div>
                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">장소</div>
                    <div id="reserveCode"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${experienceDto.exAddress}</div>

                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">인원수</div>
                    <div id="payment"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;"> ${experienceDto.exPeople}</div>
                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">진행시간</div>
                    <div id="point"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${experienceDto.exTime}</div>

                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">진행날짜</div>
                    <div id="point"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${exStartDateS}
                        ~ ${exEndDateS}</div>

                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">은행</div>
                    <div id="point"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${experienceDto.exBank}</div>
                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">계좌</div>
                    <div id="point"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${experienceDto.exAccount}</div>
                    <div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">가격</div>
                    <div id="point"
                         style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${experienceDto.exPrice}</div>
                </div>
            </div>
        </div>
