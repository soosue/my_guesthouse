...
<head>
    ...
    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=50ff539a80f0de17cdf30d7ef1f997fc&libraries=services"></script>
...
<div align="center" style="width: 100%; height: 210rem;">
                ...
                <c:forEach var="exFileDto" items="${exFileList}">
                    ...
                    <c:if test="${exFileDto.mainImgName!=null}">
                        ...
                        <div style="float:left; width: 20rem; height: 27.42rem; overflow: hidden;  margin-right: 0.5rem;">
                            <img id="exImg"
                                 style="width: 100%; height: 100%;/* position:static !important; top:0rem !important; right:0rem !important; left:0rem !important; bottom:0rem !important; object-fit:cover; */"
                                 alt="img loading" src="<spring:url value='/exImage/${exFileDto.mainImgName}' />"/>
                        </div>
                        ...
                        <c:if test="${list.index < 3 and list.index > 0}">
                            <div style="float:left; width: 20rem; height: 27.42rem; overflow: hidden; /* border: 0.01rem solid blue; */ margin-right: 0.5rem;">
                                <img id="exImg" alt="img loading"
                                     src="<spring:url value='/exImage/${exFileDto2.fileName}' />"/>
                            </div>
                        </c:if>
    ...
    <div class="wrap" style="margin:0px auto; width: 80rem; /* border: 1px dotted black;  */">
        <div id="exinfo"
             style="margin-left: 2rem; margin-top: 3.125rem; margin-bottom:3rem; width: 76rem; height: auto; border: 0.01rem solid #ffc0cb5c; float: left;">
            <ul style="width: 20rem; height:20rem; /* border: 0.1rem dotted orange; */ float: left; margin-right: 3rem;">
                <li style="width: 16rem; height: auto;">
                    ...
                    <img alt="이미지" src="https://image.flaticon.com/icons/svg/252/252041.svg"
                         style="width: 3rem; height: 3rem; margin-bottom: 1rem;"> <input type="hidden" name="exName"
                                                                                         id="exName"
                                                                                         value="${experienceDto.exName}"/>
                    <p class="text-secondary"
                       style="width: 16rem; height: 30rem; text-align: left;">${experienceDto.exName}</p>
                </li>
            </ul>
            <ul style="width: 76rem; /* height: 30rem; */ border: 0.1rem dotted khaki; display: table-header-group;">
                <li style="width: 10rem;">
                    ...
                    <img style="width: 3rem; height: 3rem; margin-bottom: 1rem;"
                         src="https://image.flaticon.com/icons/svg/251/251974.svg"/>
                ...
                <li>
                    ...
                    <img alt="이미지" src="https://image.flaticon.com/icons/svg/145/145847.svg"
                ...
                <li>
                    ...
                    <img alt="이미지" src="https://image.flaticon.com/icons/svg/217/217853.svg"
                         style="width: 3rem; height: 3rem; margin-bottom: 1rem;">
                ...
                <li style="margin-right: 3rem;">
                    ...
                    <img alt="이미지" src="https://image.flaticon.com/icons/svg/252/252020.svg"
                         style="width: 3rem; height: 3rem; margin-bottom: 1rem;"/>
                    <!-- view를 위한 날짜 포맷-->
                ...
                <li style="width: 49rem; height: auto; ">
                    ...
                    <div class="text-secondary"
                         style="width: 48rem; height: auto; word-break:break-all;text-align: left;">${experienceDto.exExplain}</div>
            ...
            <div style="width: 100%; height: 30rem; border-top: 0.2rem solid #ebebeb;border-bottom: 0.2rem solid #ebebeb; margin-top: 5rem;">
                ...
                <div style="width: 40rem; height: 26rem; /* border: 0.1rem dotted black; */ margin-left: 35rem; margin-top: 2rem; margin-bottom: 10rem;">
                    <form action="${root}/experience/exReserve.do" method="get" name="exForm"
                          onsubmit="return onExReserve(exForm)">
                        <div style="width:30rem; height:22rem;  border: 0.1rem solid #e4e4e4; margin-top: 3.5rem;">

                            <p style="width: 20rem; margin-bottom: 4rem; margin-top: 1rem; font-weight: bold; font-size: 1.5rem;">
                                예약하기</p>
                            ...
                            <div style="width:28rem;">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <input readonly="readonly" type="text" id="exDateS" name="exDateS" size="12"
                                               class="form-control"
                                               style="background-color:white; width:13rem; float: left; margin-left: 3rem; "
                                               value="${checkIn}"/>
                                ...
                                <div style="width: 28rem; /* border: 0.1rem dotted red; */ margin-top: 3rem;">
                                    ...
                                    <input type="number" name="exPeople" id="exPeople" value="${people}" min="1"
                                           max="${experienceDto.exPeople}" class="form-control" style="width:5rem"/>
                                    <input type="hidden" name="exCode" id="exCode" value="${experienceDto.exCode}"/>
                                    <input type="hidden" name="reviewList" id="reviewList"
                                           value="${reviewList.size()}"/>

                                    <input type="hidden" name="experienceDto" id="experienceDto"
                                           value="${experienceDto}">
                                </div>
                            </div>
            ...
            <div style="width: 70rem; height: auto; /* border: 0.1rem dotted orange; */ margin: 4rem;">
                <div style="width: 10rem; height: 10rem; /* border: 0.1rem solid skyblue; */ float: left; line-height: 7rem;">
                    <div style="/* margin-top: 5rem; */ height: 4rem; font-weight: bold; font-size: 1.5rem; line-height: 2rem;">
                        게스트 후기
                    </div>
                ...
                <c:if test="${memberLevel != null}">
                    <form action="${root}/experience/exReviewOk.do" method="get" name="exForm"
                        ...
                        <div>
                            ...
                            <div class="form"
                                 style="/* border: 0.1rem solid black; */ width: 57rem; margin-left: 12rem; height: 20rem; border-bottom: 0.1rem solid #ebebeb;">
                                <div class="title"
                                     style="float: left; width: 18rem; height: 3rem; /* border: 0.1rem solid gray; */ margin-top: 2rem; margin-left: 3rem;">
                                    <!-- <span>e-mail</span> -->
                                    <input type="text" name="email" size="20" value="${email}" disabled="disabled"
                                           class="form-control" width="17rem;"/>
                                ...
                                <div style="width: 15rem;height:5rem; /* border:0.1rem solid black; */">
									<span class="star-input" style="height: 5rem; margin-top: 0.3rem;">
									   <span class="input">
									     ...
									     <output for="star-input" name="starValue"><input type="hidden" name="revRate"
                                                                                          id="revRate" class="revRate"></output>
									</span>
                                ...
                                <div class="content"
                                     style="width: 50rem; height: auto; /* border: 0.1rem dotted purple; */ text-align: left; margin-top: 1rem;">
                                    <!--Review  -->
                ...
                <div style="width: 55rem; /* border: 0.1rem dotted green;  */margin-left: 10rem; margin-top: 3rem;">
                    ...
                    <div id="moreReviewB" style="margin: 3rem;">
                        ...
                        <button id="reviewBtn" type="button" class="btn btn-outline-info"
                                onclick="moreView('${root}','${emailSession}','${experienceDto.exCode}')">후기 더보기
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div style="width: 100%; height: auto; border-top: 0.2rem solid #ebebeb; border-bottom: 0.2rem solid #ebebeb; padding-bottom: 3rem;"
                 onclick="location.href='${root}/guestdelluna/myInfo.do?memberCode=${memberDto.memberCode}'">
                <div style="width: 70rem; height:auto; /* border: 0.1rem solid black; */ margin-top: 3rem; padding-top: 3rem; margin-bottom: 5rem;">
                    <ul style="width: 15rem; height:auto; float: left; /* border: 0.1rem solid black; */">
                        ...
                        <li style="list-style: none; float: left;">
                            ...
                            <img style="width: 10rem; height: 10rem;"
                                 ...
                                 class="rounded-circle" alt="이미지 없음"/>
                            <br/><br/>
                        </li>
                    </ul>
                    ...
                    <ul style="width: 45rem; height: auto; margin-left: 25rem;/*  border: 0.1rem dotted #06ff00; */">
                        <li style="list-style: none; margin-bottom: 3rem;">
                            ...
                            <p class="text-secondary"
                               style="width:15rem;/*  border: 0.1rem solid green; */text-align: left;">${memberDto.memberName}</p>
                        ...
                        <li style="margin-bottom: 3rem;">
                            ...
                            <p class="text-secondary"
                               style="width: 25rem; margin-left: 10rem; text-align: left; height: auto; word-break: break-all; ">${memberDto.memberInfo}</p>
            ...
            <div style="/* border: 0.1rem solid black; */ width: 70rem; margin-top: 3rem; margin-bottom: 5rem;">
                <div style="width:15rem; height:30rem; line-height:30rem; float: left; font-size: 1.5rem; font-weight: bold;">
                    체험장소
                </div>
...
<div class="modal fade" id="updateModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group">
                <form class="form"
                      action="${root}/experience/exReviewUpdateOk.do?memberCode=${memberCode}&exReserveCode=${exReserveCode}&pageNumber=${currentPage}"
                      method="get">
			...
			<textarea name="revContent" id="modalRevContent" class="form-control" style=" background: #fff;
                    ...
                    <div>
					   ...
					   <span class="minput" style="margin-left: 9rem; margin-bottom: 5rem;">
					     ...
					     <output for="mstar-input" name="mstarValue"><input type="hidden" name="revRate" id="revRate"
                    ...
                    <div class="modal-footer">
                        <div style="width: 10rem; margin-right: 10rem;" align="center">
                            <button id="modalSubmit" type="button" class="btn btn-info"
                                    onclick='reviewModalUpdate(form)'>수정
                            </button>
...
<div align="center" style="margin: 6rem;">
    <c:if test="${memberLevel == 'Admin'}">
        <button id="btn" type="button" class="btn btn-warning" name="stateOk"
                onclick="location.href='${root}/admin/exState.do?exCode='+'${experienceDto.exCode}'">승인
        </button>
        <button id="btn" type="button" class="btn btn-light" name="stateNo"
                onclick="location.href='${root}/admin/exStateNo.do?exCode='+'${experienceDto.exCode}'">거절
        </button>
    </c:if>
</div>
