...
<div align="center" style="width: 70rem; border: 0.1rem solid #00000059; margin: 5rem auto;">
    ...
    <div style="margin: 0rem auto;">
        <div>
            ...
            <div class="top" style="height: auto;/*  border: 0.1rem dotted orange; */">
                <div class="experience"
                     style="width: 40rem; /* border: 0.1rem dotted black; */ height: 50rem; float: left;">
                    <div id="Info"
                         style="/* border: 0.1rem solid red; */ width: 38rem; height: auto; float: left; margin-left: 3rem;">
                        ...
                        <div style="width: 25rem; height: auto; margin-left: 0.1rem; text-align: left; margin-bottom: 1.5rem; font-size: 1.3rem;">${experienceDto.exTime}
                            시간
                        </div>

                    </div>
                    <div id="img"
                         style="margin-top: 13rem; /* border: 0.1rem solid green; */ width: 30rem; height: 30rem;">
                ...
                <div style="width:25rem; height:50rem; /* border: 0.1rem dotted purple; */ margin-left: 40rem; padding-top: 8rem;">
                    <div class="reserve"
                         style="/* border: 0.1rem solid black; */ width: 26rem; height: 30rem; margin-top: 5rem;">


                        <div id="Info"
                             style="border: 0.1rem solid #ebebeb; width: 25rem; height: auto; float: left; margin-left: 1rem; padding-top: 3rem;">
                            <div style="font-weight: bold; float: left; width: 10rem;font-size: 1.5rem;">게스트</div>
                            <div id="people"
                                 style="width: 25rem; margin-left: 12rem; text-align: left; word-break: break-all; margin-bottom: 4rem;font-size: 1.3rem;"> ${exPeople}명
                            </div>

                            <div style="font-weight: bold; float: left; width: 10rem;font-size: 1.5rem;">체험 날짜</div>
                            <div id="exDate"
                                 style="width: 25rem; word-break: break-all; height: auto; margin-left: 12rem; text-align: left; margin-bottom: 4rem;font-size: 1.3rem;"> ${exDateS}</div>
                            ...
                            <div id="price"
                                 style="width: 25rem; height: auto; margin-left: 12rem; text-align: left; margin-bottom: 4rem;font-size: 1.3rem;">    ${pay}원
                                X ${exPeople}명
                            </div>

                            <div style="font-weight: bold;float: left; width: 10rem;font-size: 1.5rem;">총 합계</div>
                            <div id="total"
                                 style="width: 25rem; height: auto; margin-left: 12rem; text-align: left; margin-bottom: 4rem;font-size: 1.3rem;"> ${exPayment}
                                원
                            </div>
        ...
        <div style="margin-bottom: 5rem; margin-top: 2rem;">
            <button class="btn btn-info btn-lg" type="button" id="btn"
                    onclick="exReserveOk('${root}', '${exReserveDto.exCode}','${memberCode}','${exDateS}','${exPeople}','${exPayment}')">
                예약요청하기
            </button>
        </div>
    </div>
