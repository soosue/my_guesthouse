            ...
            <ul>
                <c:if test="${empty memberDto.memberImgName}">
                    <li>
                        ...
                        <textarea rows="10" cols="60" name="memberInfo"
                                  id="memberInfo">${memberDto.memberInfo}</textarea>
                    </li>
                </c:if>
                <li>
                    <label>숙소이름</label>
                ...
                <li>
                    ...
                    <input type="button" class="subBtn" value="내부사진업로드" onclick="subUpload()"
                ...
                <li>
                    ...
                    <input type="text" name="account" id="account" placeholder="'-'제외하고 입력해주세요."
                           onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" size="30"/>
                </li>
                <li>
                    <label>금액</label>
